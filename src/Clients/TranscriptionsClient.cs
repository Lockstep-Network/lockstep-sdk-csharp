...
namespace LockstepSDK.Clients
{
    ...
    public class TranscriptionsClient
    {
        ...
        public async Task<LockstepResponse<TranscriptionValidationRequest>> RetrieveTranscriptionValidationRequest(Guid id, string include = null)
        {
            var url = $"/api/v1/Transcriptions/validate/{id}";
            var options = new Dictionary<string, object>();
            if (include != null) { options["include"] = include; }
            return await _client.Request<TranscriptionValidationRequest>(HttpMethod.Get, url, options, null, null);
        }
        ...
        public async Task<LockstepResponse<TranscriptionValidationRequest>> UpdateTranscriptionValidationRequest(Guid id, object body)
        {
            var url = $"/api/v1/Transcriptions/validate/{id}";
            return await _client.Request<TranscriptionValidationRequest>(new HttpMethod("PATCH"), url, null, body, null);
        }
        ...
        public async Task<LockstepResponse<TranscriptionValidationRequest>> CreateTranscriptionValidationRequest(TranscriptionRequestSubmit[] body)
        {
            var url = $"/api/v1/Transcriptions/validate";
            return await _client.Request<TranscriptionValidationRequest>(HttpMethod.Post, url, null, body, null);
        }
        ...
        public async Task<LockstepResponse<FetchResult<TranscriptionValidationRequest>>> QueryTranscriptionValidationRequests(string filter = null, string include = null, string order = null, int? pageSize = null, int? pageNumber = null)
        {
            ...
            return await _client.Request<FetchResult<TranscriptionValidationRequest>>(HttpMethod.Get, url, options, null, null);
        }
    }
}
