...
namespace LockstepSDK.Clients
{
    ...
    public class UserAccountsClient
    {
        ...
        ///
        /// </summary>
        /// <param name="id">The unique ADS Platform ID number of this User</param>
        [Obsolete("This endpoint is deprecated.")]
        ...
        /// <summary>
        /// This route is obsolete, please use the /UserAccounts/invite to reenable a disabled user.
        ///
        ...
        /// <summary>
        /// Queries Users for this account using the specified filtering, sorting, nested fetch, and pagination rules requested. A User represents a person who has the ability to authenticate against the ADS Platform and use services such as ADS Inbox.  A User is uniquely identified by an Azure identity, and each user must have an email address defined within their account.  All Users must validate their email to make use of ADS Platform services.  Users may have different privileges and access control rights within the ADS Platform.
        ///
        /// </summary>
