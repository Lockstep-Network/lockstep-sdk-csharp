...
namespace LockstepSDK.Clients
{
    ...
    public class InvoicesClient
    {
        ...
        /// <param name="include">To fetch additional data on this object, specify the list of elements to retrieve. Available collections: Addresses, Lines, Payments, Notes, Attachments, Company, Customer, CustomFields, CreditMemos, WorkflowStatuses</param>
        ...
        ///
        /// </summary>
        /// <param name="customerCompanyId">The ID of the customer company. Only to be used with the UBL file upload multipart/form-data option.</param>
        /// <param name="filename">The full path of a file to upload to the API</param>
        /// <param name="body">Upload a UBL file or provide an InvoiceModel array</param>
        public async Task<LockstepResponse<InvoiceModel[]>> CreateInvoices(string filename, InvoiceModel[] body, Guid? customerCompanyId = null)
        {
            var url = $"/api/v1/Invoices";
            var options = new Dictionary<string, object>();
            if (customerCompanyId != null) { options["customerCompanyId"] = customerCompanyId; }
