...
namespace LockstepSDK.Clients
{
    ...
    public class InvoicesClient
    {
        ...
        public async Task<LockstepResponse<InvoiceModel[]>> CreateInvoices(string filename, InvoiceModel[] body)
        {
            var url = $"/api/v1/Invoices";
            return await _client.Request<InvoiceModel[]>(HttpMethod.Post, url, null, body, filename);
        }
