...
namespace LockstepSDK.Clients
{
    ...
    public class CustomFieldValuesClient
    {
        ...
        ///
        /// </summary>
        /// <param name="definitionId">The unique ADS Platform ID number of the Custom Field Definition for the Custom Field Value to retrieve.</param>
        /// <param name="recordKey">The unique ADS Platform ID number of the ADS Platform object the Custom Field Value is attached to.</param>
        ...
        /// <summary>
        /// Queries Custom Fields within the ADS Platform using the specified filtering, sorting, nested fetch, and pagination rules requested.
        ///
