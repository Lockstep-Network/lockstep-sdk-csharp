...
namespace LockstepSDK.Clients
{
    ...
    public class AttachmentsClient
    {
        ...
        public async Task<LockstepResponse<AttachmentModel>> RetrieveAttachment(Guid id, string include = null)
        {
        ...
        public async Task<LockstepResponse<AttachmentModel[]>> UploadAttachment(string tableName, Guid objectId, string filename, string attachmentType = null)
        {
