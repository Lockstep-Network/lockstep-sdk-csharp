...
namespace LockstepSDK
{
    ...
    public class CurrenciesClient
    {
        ...
        public async Task<LockstepResponse<CurrencyRateModel>> Retrievecurrencyrate(string sourceCurrency, string destinationCurrency, string date = null, string dataProvider = null)
        {
        ...
        public async Task<LockstepResponse<CurrencyRateModel[]>> Bulkcurrencydata(BulkCurrencyConversionModel[] body, string destinationCurrency = null)
        {
