...
namespace LockstepSDK.Models
{
    ...
    /// <summary>
    /// The JournalEntryLineSyncModel represents information coming into ADS from an external financial system or other
    ...
    public class JournalEntryLineSyncModel
    {
        ...
        /// </summary>
        public string SourceObjectErpKey { get; set; }
